        ...
        <div class="row justify-content-center">
            <div class="mbr-white col-md-10">
                ...
                <div class="mbr-section-btn align-center">
                        <a class="btn btn-md btn-secondary display-4" href="bread.php">Yes</a>
                        <a class="btn btn-md btn-white-outline display-4" href="nutrition.php">No, view nutritional value</a></div>
            </div>
        </div>
    </div>
