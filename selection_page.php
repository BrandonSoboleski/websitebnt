...
<script type="text/javascript">
  function prebuilt()
  {
    document.getElementById("btnnext").href="prebuilt.php"; 
  }
  function custom()
  {
    document.getElementById("btnnext").href="bread.php"; 
  }
</script>
<body>
        ...
        <div class="row justify-content-center">
            <div class="mbr-white col-md-10">
                ...
                <div class="mbr-section-btn align-center">
                        <a class="btn btn-md btn-secondary display-4" onclick="prebuilt()">Prebuilt</a>
                        <a class="btn btn-md btn-white-outline display-4" onclick="custom()">Custom</a></div>
            </div>
        </div>
		<div class="row justify-content-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1">Choose Your Sandwich Size</h1>
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-white-outline display-4" >4 in.</a>
                        <a class="btn btn-md btn-white-outline display-4" >6 in.</a>
						<a class="btn btn-md btn-white-outline display-4" >12 in.</a></div>
						<div class="mbr-section-btn align-center"><a class="btn btn-md btn-white-outline display-4" >I am a Florida Customer</a></div>
