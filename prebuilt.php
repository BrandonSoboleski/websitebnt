...
<body>
  <section class="header5 cid-rFLInF4iNo mbr-fullscreen" id="header5-9">
    ...
    <div class="row" id="optiongrid">
      <div class="row">
        <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1"  style="padding-left: 400px;"> Choose a Prebuilt Sandwich</h1>
      </div>
      <div class="column">
        <div class="container">
          <img src="img_sandwich.jpg" alt="sandwich" style="width:100%; padding-bottom: 60px;padding-left: 10px;">
          <a class="btn btn-md btn-white-outline display-4" onclick="allownext()" style="width:100%; height:40px;">Roast Beef</a>
        </div>
        <div class="container">
          <img src="img_sandwich.jpg" alt="sandwich" style="width:100%; padding-bottom: 60px;padding-left: 10px;">
          <a class="btn btn-md btn-white-outline display-4" onclick="allownext()" style="width:100%; height:40px;">Roast Beef</a>
